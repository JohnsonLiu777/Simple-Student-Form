    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="alert alert-warning" v-if="this.errors && Object.keys(this.errorList).length < 0 ">
...
export default {
    ...
    data() {
        return {
            studentId:'',
            errorList: '',  // Selalu diinisialisasi sebagai objek
            model: {
                student: {
                    name: '',
                    course: '',
    ...
    methods: {
        getStudentData(studentId){
            axios.get(`http://localhost:8000/api/students/${studentId}/edit`)       //Mengambil data berdasarkan id
            .then(res => {
                console.log(res.data.student);
                this.model.student = res.data.student             //Untuk nama
        ...
        updateStudent() {
            ...
            axios.put(`http://localhost:8000/api/students/${this.studentId}/edit`, this.model.student)
                .then(res => {
                    ...
                    // Reset errorList setelah berhasil
                    this.errorList = '';
                })
                .catch(function(error){
                    if (error.response) {
